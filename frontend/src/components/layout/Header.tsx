    ...
    <header className="sticky top-0 z-40">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center md:hidden">
              <button
                onClick={toggleMenu}
                className="p-2 rounded-md bg-white/10 hover:bg-white/20 text-white transition duration-200"
      ...
      {isMenuOpen && (
        <motion.div
          ...
          className="md:hidden bg-black/70 backdrop-blur-md border-b border-white/10"
        >
