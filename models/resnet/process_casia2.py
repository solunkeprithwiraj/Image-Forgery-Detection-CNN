"""
Script to preprocess CASIA2 dataset for ResNet training.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Preprocess CASIA2 dataset for ResNet training')
    parser.add_argument('--input_dir', type=str, default='data/casia2',
                      help='Directory containing the CASIA2 dataset')
...
def process_images(input_dir, output_dir, resize_size, crop_size):
    """Process all images in the CASIA2 dataset."""
...
def main():
    ...
    print(f"Preprocessing CASIA2 dataset from {args.input_dir} to {args.output_dir}")
